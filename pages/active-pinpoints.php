...
<html lang="en">
  <head>
    <title>Active Pinpoints - Electro Map</title>
    <meta charset="UTF-8" />
    ...
    <script defer src="../js/pinpoints.js?v=1.0.5"></script>
  </head>
  ...
  <body>
    ...
    <main id="pinpointsSectionPage">
      <div id="activeContainer">
        <div class="searchContainer">
          <p>Active Pinpoints</p>
          <input
            type="text"
            id="activeSearch"
            class="searchBox"
            placeholder="Search active pinpoints..."
          />
        </div>
        <ul id="activePinpoints">
          <li>No active pinpoints</li>
        </ul>
      </div>
    </main>

    <div class="pinInfoModalBackground">
      <div class="pinInfoModal">
        <img id="pinInfoCloseBtn" src="/assets/closeIcon.svg" alt="closeIcon" />
        <div id="infoMap"></div>
        ...
        <img id="infoImage" alt="infoImage" />
      </div>
    </div>
