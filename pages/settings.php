...
<html lang="en">
  <head>
    <title>Profile - Electro Map</title>
    <meta charset="UTF-8" />
    ...
    <script defer src="../js/settings.js?v=1.0.5"></script>
  </head>
  ...
  <body>
    ...
    <main>
      ...
      <div class="settings-container">
        ...
        <div
          class="common-setting-container"
          id="pendingContributionsSection"
          style="display: none"
          onclick="goToPendingContributions()"
        >
          <p>Pending Contributions</p>
        </div>
        <div
          class="common-setting-container"
          id="activePinpointsSection"
          style="display: none"
          onclick="goToActivePinpoints()"
        >
          <p>Active Pinpoints</p>
        </div>
        <div
          class="common-setting-container"
          id="checkUsersSection"
          style="display: none"
      ...
      <div id="logoutBtn" onclick="LogoutSession()">Logout</div>
    </main>
  </body>
</html>
